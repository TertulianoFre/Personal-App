...
type Props = NativeStackScreenProps<PersonalAlunosStackParamList, 'VerEvolucao'>;

type AvaliacaoComUrls = AvaliacaoFisica & { fotoUrls: string[] };

export default function VerEvolucaoScreen({ route }: Props) {
  ...
  return (
    <View style={styles.screen}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.emptyText}>Este aluno ainda não registrou avaliações físicas.</Text>}
        renderItem={({ item }) => (
...
const styles = StyleSheet.create({
  ...
  summaryCard: { ...shared.card, marginHorizontal: spacing.md, marginTop: spacing.md, alignItems: 'center' },
